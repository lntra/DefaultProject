...
import { brand, nav, navCta } from '../content/copy'
import './Header.css'
...
export function Header() {
  ...
  return (
    <header className="header">
      ...
      <nav id="site-menu" className="header__menu" data-open={open} aria-label="Principal">
        {nav.map((item) => (
      ...
      <a className="btn btn--primary header__cta" href={toHome('#contato')}>
        {navCta}
